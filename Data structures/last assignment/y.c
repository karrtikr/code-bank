...
int main(){
	int a[100000],b[100000],c[100000],d[100000],i,j,n,size=100,count,k;
	clock_t start[4],end[4];
	double sum[4] = {0,0,0,0},x[4],y[4];
	while(size<=100000){
		for(i=0;i<1000;i++){
			for(j=0;j<size;j++){
				a[j]=rand();
